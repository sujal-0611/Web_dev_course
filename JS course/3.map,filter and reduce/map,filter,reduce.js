...
let new_arr3= arr3.reduce((element1 ,element2) =>{
    let result= element1+element2 ;     // i.e add all numbers together
    return result;
    //now result is sent to element1 and element 2 would have next element
    //dry run: for first call element1=1 and element2=2 now result = 3 and result is sent to element1 , so now element1=3 and element2 = 5 
});
